...
**[Leaderboard]**JavaScript project for a Leaderboard list app, using webpack and ES6 features, notably modules. This product will consume the Leaderboard API using JavaScript async and await.
